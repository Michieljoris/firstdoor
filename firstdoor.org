...
** 24/2/14  .5h replacing slideshow with static image
   ...
   http://www.jqueryscript.net/social-media/jQuery-Plugin-For-Custom-Facebook-Like-Button-Fancylike.html
...
* doing 
 Sync to local copy, then run live version
Sync to linode test live, test firstdoor.axion5.net 
Sync all but blog to live on linode
Add unpublished widget
Hide meta on firstdoor on logged out status
